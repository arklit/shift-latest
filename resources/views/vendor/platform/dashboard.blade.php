...
@section('aside')
    <div class="aside col-xs-12 col-xxl-2 bg-dark d-flex flex-column admin-background" data-controller="menu">
...
@section('workspace')
    ...
    <div class="order-last order-md-0 command-bar-wrapper">
        <div class="@hasSection('navbar') @else d-none d-md-block @endif commandbar-layout layout d-md-flex align-items-center">
